...
window.PM.registerDataset('tricity-aerotropolis', {
  ...
  keyRoads: [
    { id:'airport-road', name:'Airport Road', svgId:'ROAD-Airport-Road', easyD:'M 70 250 C 470 215 980 225 1370 205', labelAt:[770,205], photos:true, mapsUrl:'https://www.google.com/maps/search/?api=1&query=Airport+Road+Mohali', related:['Aerocity','IT City Side','Aerotropolis'] },
    ...
    { id:'mohali-sirhind', name:'Mohali–Sirhind Road', svgId:'ROAD-Mohali-Sirhind-Road', easyD:'M 960 110 L 985 910', labelAt:[985,150], vertical:true, photos:true, mapsUrl:'https://www.google.com/maps/search/?api=1&query=Mohali+Sirhind+Road', related:['Aerotropolis Blocks'] },
    { id:'pr8',  name:'PR-8 Road',  svgId:'ROAD-PR-8-Road', easyD:'M 70 705 C 470 685 980 690 1370 705', labelAt:[300,690], photos:true, mapsUrl:'https://www.google.com/maps/search/?api=1&query=PR8+Road+Mohali', related:['Aerotropolis Blocks'] },
    { id:'bharatmala', name:'Bharatmala / Zirakpur–Banur Corridor', label:'Bharatmala Corridor', internalNote:'confirm source label before expanding beyond demo', svgId:'ROAD-Bharatmala-Zirakpur-Banur-Corridor', easyD:'M 70 880 L 1370 690', labelAt:[1010,765], photos:true, mapsUrl:'https://www.google.com/maps/search/?api=1&query=Zirakpur+Banur+Highway', related:['Aerotropolis','Future Growth'] },
    ...
    { id:'pr12', name:'PR-12 Road', svgId:'ROAD-PR-12-Road', easyD:'M 1180 120 L 1205 900', labelAt:[1205,160], vertical:true, photos:true, mapsUrl:'https://www.google.com/maps/search/?api=1&query=PR12+Road+Mohali', related:['Aerotropolis'] },
    { id:'railway', name:'Mohali Railway Station Road', svgId:'ROAD-Mohali-Railway-Station-Road', easyD:'M 1010 255 C 1130 380 1210 560 1290 880', labelAt:[1235,720], photos:true, mapsUrl:'https://www.google.com/maps/search/?api=1&query=Mohali+Railway+Station', related:['Aerocity'] },
  ...
  blocks: [
    { id:'ac-a', area:'Aerocity', cat:'aerocity-blk', name:'Sector 66A', svgId:'SECTOR-Aerocity-Sector-66A', x:300, y:300, w:150, h:115 },
    { id:'ac-b', area:'Aerocity', cat:'aerocity-blk', name:'Sector 66B', svgId:'SECTOR-Aerocity-Sector-66B', x:300, y:445, w:150, h:115 },
    { id:'ac-c', area:'Aerocity', cat:'aerocity-blk', name:'Sector 82', svgId:'SECTOR-Aerocity-Sector-82', x:300, y:590, w:150, h:115 },
    { id:'ac-1', area:'Aerocity', cat:'aerocity-blk', name:'Sector 82A', svgId:'SECTOR-Aerocity-Sector-82A', x:140, y:445, w:135, h:115 },
    { id:'at-a', area:'Aerotropolis', cat:'aerot-blk', name:'Block A', svgId:'BLOCK-Aerotropolis-Block-A', x:660, y:430, w:150, h:120 },
    { id:'at-b', area:'Aerotropolis', cat:'aerot-blk', name:'Block B', svgId:'BLOCK-Aerotropolis-Block-B', x:825, y:430, w:150, h:120 },
    { id:'at-c', area:'Aerotropolis', cat:'aerot-blk', name:'Block C', svgId:'BLOCK-Aerotropolis-Block-C', x:660, y:565, w:150, h:120 },
    { id:'at-d', area:'Aerotropolis', cat:'aerot-blk', name:'Block D', svgId:'BLOCK-Aerotropolis-Block-D', x:825, y:565, w:150, h:120 }
  ],

  zones: [
    { id:'commercial-belt', cat:'commercial', name:'Commercial Belt', svgId:'ZONE-Commercial-Zone-B', x:1010, y:430, w:200, h:170, mapsUrl:'https://www.google.com/maps/search/?api=1&query=Aerocity+Commercial+Mohali', related:['Aerocity','Aerotropolis Blocks'], photos:true },
    { id:'education-hub', cat:'institutions', name:'Education & Institutional Hub', x:620, y:250, w:360, h:130, mapsUrl:'https://www.google.com/maps/search/?api=1&query=Knowledge+City+Mohali', related:['Aerocity','Amity University','Plaksha University'], photos:true,
      pins:[ { name:'Amity University Punjab', svgId:'PIN-Amity-University-Punjab', at:[700,315] }, { name:'Plaksha University', svgId:'PIN-Plaksha-University', at:[850,315] } ] },
    { id:'it-hub', cat:'it', name:'IT City / Employment Hub', svgId:'PIN-Infosys-Mohali', x:1030, y:630, w:200, h:160, mapsUrl:'https://www.google.com/maps/search/?api=1&query=IT+City+Mohali', related:['Aerocity','IT City Side'], photos:true },
  ...
  pins: [
    { id:'medicity',  cat:'medical', name:'Medicity · Multi-speciality', svgId:'PIN-Institute-Mohali', at:[1130,360], mapsUrl:'https://www.google.com/maps/search/?api=1&query=Medicity+Mohali', related:['Aerotropolis'], photos:true },
