...
window.PM.registerDataset('tricity-aerotropolis', {
  ...
  zones: [
    { id:'commercial-a', cat:'commercial', name:'Commercial Zone A', svgId:'ZONE-Commercial-Zone-A', labelAt: [3550, 1340], x:1010, y:430, w:200, h:170, photos:true },
    { id:'commercial-b', cat:'commercial', name:'Commercial Zone B', svgId:'ZONE-Commercial-Zone-B', labelAt: [3150, 1290], x:1010, y:430, w:200, h:170, photos:true },
    { id:'commercial-c', cat:'commercial', name:'Commercial Zone C', svgId:'ZONE-Commercial-Zone-C', labelAt: [2820, 1349], x:1010, y:430, w:200, h:170, photos:true },
    { id:'commercial-c2', cat:'commercial', name:'Commercial Zone C2', svgId:'ZONE-Commercial-Zone-C_2', labelAt: [2820, 1413], x:1010, y:430, w:200, h:170, photos:true },
